...
import static com.cd.moyu.paper.manager.common.consts.StatusCode.*;
...
public class Result {
    ...
    public static Result fail(String message, StatusCode code) {return restResult(false, null, code.getCode(), message);}
